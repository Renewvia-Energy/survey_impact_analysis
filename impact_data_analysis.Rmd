...
-   Our independent variables will be at two levels:
    ...
    -   Individual: Energy Consumption (kWh)
...
```{r}
ind_vars <- c("pv_size_kwh", "customer_count", "capex_usd")
...
```{r}
## Paired Individual Differences
consumption_reg(df = paired_enc, reg_type ="linear",
                dep= "water_collection_time", ind="consumption_period",
                calc_diff=TRUE, diff_type = "magnitude",
                x_axis="Energy Consumption In Period (kwH)", 
                y_axis="Water Collection Time",
                title="Individual Differences vs Consumption")
```
...
community_reg(df=ci_enc, 
              ...
              exclude_outliers = TRUE, outliers = "feature",
              customer_type="ci", y_axis= "Women Workers",
...
consumption_reg(df = df_reg, reg_type ="linear",
                ...
                exclude_outliers = TRUE, outliers = "feature",
                x_axis="Energy Consumption Cumulative (kwH)", 
                y_axis="Women Workers",
...
consumption_reg(df = ci_enc, reg_type ="logistic",
                dep= "ci_offering_change", ind="consumption_all",
                exclude_outliers = TRUE, outliers = "feature",
                x_axis="Energy Consumption Cumulative (kwH)", 
                y_axis="Change In C&I's Offering",
...
```{r}
consumption_reg(df = paired_enc, reg_type ="linear",
                dep= "kerosene_lamps_count", ind="consumption_period",
                calc_diff=TRUE, diff_type="magnitude",
...
consumption_reg(df = sub, reg_type ="linear", ind="consumption_all",
