...
```{r}
a <- c(unique(initial_pre$feel_unsafe_reasons[is.na(initial_pre$feel_unsafe_reasons) == FALSE]),
  unique(post_clean$feel_unsafe_reasons[is.na(post_clean$feel_unsafe_reasons) == FALSE]))
...
#### TODO: Subgroup Analysis by Gender, Community
