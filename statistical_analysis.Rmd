...
# Nigerian Women
gdr <- "female"
women_paired <- nigeria_df %>% filter(gender_post == gdr)
paired_testing(women_paired, var_name="avg_household_income",
               test_type = "ttest", plot_diff=TRUE)

# Nigerian Men
gdr <- "male"
men_paired <- nigeria_df %>% filter(gender_post == gdr)
...
# Nigerian Women
gdr <- "female"
women_paired <- kenya_df %>% filter(gender_post == gdr)
paired_testing(women_paired, var_name="avg_household_income",
               test_type = "ttest", plot_diff=TRUE)

# Nigerian Men
gdr <- "male"
men_paired <- kenya_df %>% filter(gender_post == gdr)
paired_testing(men_paired, var_name="avg_household_income",
               test_type = "ttest", plot_diff=TRUE)
```
